...
import { modelX } from "../common/specs/data";
  ...
  return (
    <>
      {tags ? (
        <HelmTags
          title={tags.modelX[0]}
          titleru={tags.modelXru[0]}
          desc={tags.modelX[1]}
          descru={tags.modelXru[1]}
          img={tags.modelX[2]}
        />
      ) : null}
      <MainScreenModel
        bg={"/images/bg/ModelX_Bg.jpg"}
        mbg={"/images/bg/ModelX_Bg_mob.jpg"}
        model={i18n.language === "ua" ? modelsData.modelX : modelsData.modelXru}
      />
      <Black />
      <ImageBlock bg={"/images/konfigurator/cars/modelX_white.jpg"} />
      {/* Blok1 */}
      <BlackBlock>
        <BlockImage bg={"/images/pages/modelX_1.png"} />
        <BlockText>
        ...
        <BlockImage bg={"/images/pages/modelX_2.png"} />
      </BlackBlock>
      ...
      <BlackBlock>
        ...
        <BlockImage bg={"/images/pages/modelX_3.png"} />
        <BlockImage bg={"/images/pages/modelX_4.png"} />
        <BlockText>
        ...
        <BlockImage bg={"/images/pages/modelX_5.png"} />
      </BlackBlock>
      ...
      <Configurator href={"/konfigurator/modelX"} />
      <Footer />
    </>
  );
};
