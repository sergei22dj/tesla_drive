...
import { modelY } from "../common/specs/data";
...
const ModelY = ({ tags }) => {
  ...
  return (
    <>
      ...
      <MainScreenModel
        bg={"/images/bg/ModelY_Bg.jpg"}
        mbg={"/images/bg/ModelY_Bg_mob.jpg"}
        model={i18n.language === "ua" ? modelsData.modelY : modelsData.modelYru}
      />
      ...
      <Specs
        ...
        var2={"Long Range AWD"}
      />
      <Configurator href={"/konfigurator/modelY"} />
      <Footer />
    </>
  );
};
...
const ImageBlockTesla = styled.div`
  display: flex;
  background-image: url("/images/pages/modelY.jpeg");
  background-position: center;
  width: 100%;
  height: 970px;
  background-repeat: no-repeat;
  background-size: cover;
  @media screen and (max-width: 800px) {
    background-image: url("/images/pages/modelY2.jpeg");
    height: 600px;
  }
`;
